  ...
  return (
    <div className="w-[70%] mx-auto my-5">
      <form className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          className=" lg:w-[10rem] w-[8rem] items-center px-5 py-2.5 text-[10px] lg:text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800"
        >
          Update post
        </button>
      </form>
